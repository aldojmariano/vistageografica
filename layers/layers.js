...
lyr_GoogleSatellite_0.setVisible(true);lyr_PERIMETRO_1.setVisible(true);lyr_MANZANAS_2.setVisible(false);lyr_LOTES_3.setVisible(true);lyr_VIAS_4.setVisible(true);
var layersList = [lyr_GoogleSatellite_0,lyr_PERIMETRO_1,lyr_MANZANAS_2,lyr_LOTES_3,lyr_VIAS_4];
...
lyr_VIAS_4.set('fieldAliases', {'TIPO_VIA': 'TIPO_VIA', 'NOMBRE': 'NOMBRE', 'ROTULO': 'ROTULO', });
...
lyr_VIAS_4.set('fieldImages', {'TIPO_VIA': 'TextEdit', 'NOMBRE': 'TextEdit', 'ROTULO': 'TextEdit', });
...
lyr_VIAS_4.set('fieldLabels', {'TIPO_VIA': 'no label', 'NOMBRE': 'no label', 'ROTULO': 'no label', });
lyr_VIAS_4.on('precompose', function(evt) {
